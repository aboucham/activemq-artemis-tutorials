...
    - "addressConfigurations.orders.queueConfigs.orders.routingType=MULTICAST
    ...
    - AMQPConnections.target.password=admin
    - AMQPConnections.target.autostart=true
    - AMQPConnections.target.federations.address-federation-to-remote.type=FEDERATION
    - AMQPConnections.target.federations.address-federation-to-remote.localAddressPolicies.policy1.includes.m4.addressMatch=orders
    - AMQPConnections.target.federations.address-federation-from-remote.type=FEDERATION
    - AMQPConnections.target.federations.address-federation-from-remote.remoteQueuePolicies.policy1.includes.m4.queueMatch=tracking
----
